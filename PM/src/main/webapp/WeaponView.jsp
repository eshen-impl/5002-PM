	...
	<h1>${messages.title}</h1>
        <table border="1">
            ...
            <tr>
    			...
    			<td><c:out value="${equippable.getDamageDone()}" /></td>
    			<td><c:out value="${equippable.getAutoAttack()}" /></td>
    			<td><c:out value="${equippable.getAttackDelay()}" /></td>
    			<td><c:out value="${equippable.getAssociatedJob().getJobName()}" /></td>
